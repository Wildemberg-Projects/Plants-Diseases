...
if os.getenv('DEVELOPMENT'):
    mlflow.set_tracking_uri(os.getenv('URL_DB_SQLITE'))
else:
    mlflow.set_tracking_uri(os.getenv('URL_DB_POSTGRES'))
...
MODEL = tf.keras.models.load_model("../models/Plant-Diseases-v2")
